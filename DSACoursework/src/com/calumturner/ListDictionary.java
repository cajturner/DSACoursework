...
public class ListDictionary implements Dictionary{
	 ...
	 * Initialises ll to a new Link List type String.
	 */
	 ...
	 * @param String key. A String to be added to the the linked list.
	 */
	@Override
	public void insert(String key) {
		if(!find(key))ll.add(key);
	}

	/**
	 * Removes key from linked list, if ll.remove returns false throw an key not found exception.
	 * @param String key. A String to be removed from the linked list.
	 */
	@Override
	 ...
	 * @param String key. A String to be searched for in the linked list.
