...
public class spell {
	...
	public static void main(String[] args) throws java.io.IOException {
		...
		if (args.length != 2) {
			System.out
					.println("Usage: spell dictionaryFile.txt inputFile.txt ");
			System.exit(0);
		}
		...
		System.out.println(args[0] + " -> " + args[1] + ". Running time: "
				+ (endTime - startTime));
	}

	/**
	 * Goes over all the characters in the String word and tries to replace them
	 * with any other character, if a new word is found, insert it to the word
	 * dictionary.
	 * 
	 * @param String
	 *            word. A word not in the dictionary.
	 * 
	 */
	...
	/**
	 * Removes one character from the String word and checks if the new word is
	 * in the dictionary, if so add to word dictionary.
	 * 
	 * @param String
	 *            word. A word not in the dictionary.
	 */
	private static void letterOmi(String word) {
		...
		for (int i = 0; i < word.length(); i++) {
			...
			if (hDict.find(newWord))
				wordsDict.insert(newWord);
		}
	}

	/**
	 * Inserts all in succession before, between and after each character for
	 * String word. If any new words match to the dictionary. Add new word to
	 * word dictionary.
	 * 
	 * @param String
	 *            word. A word not in the dictionary.
	...
	/**
	 * Swaps pairs of characters within String word. If any new words match to
	 * the dictionary. Add new word to word dictionary.
	 * 
	 * @param String
	 *            word. A word not in the dictionary.
	 */
